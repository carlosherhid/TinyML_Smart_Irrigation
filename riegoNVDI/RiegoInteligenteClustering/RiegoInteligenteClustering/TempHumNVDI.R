...
################################################
ini_mediciones = as.Date("2018-01-6")  #Fecha de inicio para filtrar a partir de ahí los datos de humedad y temperatura (diez dias antes para obtener las 10 mediciones anteriores a la primera)
